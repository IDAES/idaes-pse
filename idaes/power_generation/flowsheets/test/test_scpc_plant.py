...
def test_power_plan():
    ...
    # This step appends all the unit models into our model ("m")
    ...
    # constant (~866 K), we need to fix Attemperator enthalpy outlet and
    # unfix heat duty to Platen superheater, note that fixing enthalpy
