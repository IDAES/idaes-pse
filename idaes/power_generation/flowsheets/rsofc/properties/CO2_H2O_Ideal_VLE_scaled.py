...
configuration = {
        ...
        'Ar': {"type": Component,
                ...
                "parameter_data": {
                   ...
                   "cp_mol_ig_comp_coeff": {                 # [1], temperature range 298 K - 1200 K
                       ...
                       'B': (2.825911e-07, pyunits.J*pyunits.mol**-1*pyunits.K**-1*pyunits.kiloK**-1),
                       'C': (-1.464191e-07, pyunits.J*pyunits.mol**-1*pyunits.K**-1*pyunits.kiloK**-2),
                       'D': (1.092131e-08, pyunits.J*pyunits.mol**-1*pyunits.K**-1*pyunits.kiloK**-3),
                       'E': (-3.661371e-08, pyunits.J*pyunits.mol**-1*pyunits.K**-1*pyunits.kiloK**2),
    ...
    "state_bounds": {"flow_mol": (0, 8000, 1e6, pyunits.mol/pyunits.s),
                     "temperature": (273.15, 500, 2500, pyunits.K),
                     "pressure": (5e4, 1.3e5, 1e9, pyunits.Pa)},
