...
def build_reformer(m):
    ...
    # TODO - how is the value of 2.868 used for computing air flow to reformer obtained
    @m.fs.Constraint()
...
def set_reformer_inputs(m):
    ...
    # m.fs.air_compressor_s1.inlet.flow_mol[0] == 280  # mol/s
    ...
    # m.fs.air_compressor_s1.inlet.mole_frac_comp[0, 'H2O'].fix(0.0017)
    # m.fs.air_compressor_s1.inlet.mole_frac_comp[0, 'N2'].fix(0.002)
    # m.fs.air_compressor_s1.inlet.mole_frac_comp[0, 'O2'].fix(0.995)
    # m.fs.air_compressor_s1.inlet.mole_frac_comp[0, 'Ar'].fix(0.001)
    ...
    # m.fs.air_compressor_s1.outlet.pressure.fix(126863.5)  # Pa, equal to 18.4 psia
