...
def add_preheater(m):
    ...
    #  Specify performance variables of unit operations
    ########################################################################### 
    m.fs.oxygen_preheater.area.fix(2000)
...
def add_constraints(m):
    ...
    def soec_steam_temperature_eqn(b, t):
        return (m.fs.bhx2.tube.properties_out[t].temperature ==
    ...
    # TODO - addconstraint for cmb Q to in-bed heat exchanger (produces steam)
...
def do_initialize(m, solver):
    ...
    m.fs.oxygen_preheater.initialize(outlvl=idaeslog.DEBUG)
