...
def add_constraints(m):
    ...
    @m.fs.Constraint()
    def air_to_combustor(b):
        XS = 1.09  # excess oxygen

        F_CH4 = (m.fs.ng_preheater.tube_inlet.flow_mol[0] *
                 m.fs.ng_preheater.tube_inlet.mole_frac_comp[(0, "CH4")])
        F_C2H6 = (m.fs.ng_preheater.tube_inlet.flow_mol[0] *
                m.fs.ng_preheater.tube_inlet.mole_frac_comp[(0, "C2H6")])
        F_C3H8 = (m.fs.ng_preheater.tube_inlet.flow_mol[0] *
                m.fs.ng_preheater.tube_inlet.mole_frac_comp[(0, "C3H8")])
        F_C4H10 = (m.fs.ng_preheater.tube_inlet.flow_mol[0] *
                m.fs.ng_preheater.tube_inlet.mole_frac_comp[(0, "C4H10")])        
        O2_required = 2*F_CH4 + 3.5*F_C2H6 + 5*F_C3H8 + 6.5*F_C4H10

        O2_fed = (m.fs.air_compressor_s1.inlet.flow_mol[0] *
                  m.fs.air_compressor_s1.inlet.mole_frac_comp[(0, "O2")])
