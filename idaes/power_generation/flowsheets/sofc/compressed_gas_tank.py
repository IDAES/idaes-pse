...
# (DISPATCHES), and is copyright (c) 2021 by the software owners: The Regents
# of the University of California, through Lawrence Berkeley National
# Laboratory, National Technology & Engineering Solutions of Sandia, LLC,
# Alliance for Sustainable Energy, LLC, Battelle Energy Alliance, LLC,
# University of Notre Dame du Lac, etal. All rights reserved.
#
# Please see the files COPYRIGHT.md and LICENSE.md for full copyright and
# license information, respectively.
# Both files are also available online at the URL:
