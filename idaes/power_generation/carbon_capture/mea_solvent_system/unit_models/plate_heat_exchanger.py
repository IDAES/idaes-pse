...
**MomentumBalanceType.momentumPhase** - momentum balances for each phase.}"""))
    ...
    def build(self):
        ...
        # =====================================================================
        # Case specific performance equations
        # ---------------------------------------------------------------------
        # Calculating heat transfer

        # ---------------------------------------------------------------------
        # Calculating pressure drop
        # Gch, Gph - these are port and channel velocities
        # self.pass_number = Var(
        #     initialize=4,
        #     domain=PositiveIntegers,
        #     units=pyunits.dimensionless,
        #     doc="Total number of passes for hot and cold fluid")
        ...
        #     domain=PositiveReals,
        #     units=hunits("length"),
        #     doc="Length of each plate")

        # self.channel_diameter = Var(
        #     initialize=1.6925,  # need a default value for this
        #     domain=PositiveReals,
        #     units=hunits("length"),
        #     doc="Channel equivalent diameter")

        # def rule_deltaP_hot(blk, t):
        #     return blk.hot_side.deltaP[t] == -(
        #         (2*blk.fric_h[t]*(blk.plate_length + blk.port_diameter) *
        #          blk.pass_number*Gch[t]**2 /
        #          (blk.hot_side.properties_in[t].dens_mass *
        #           blk.channel_diameter)) +
        #         (0.7*blk.pass_number*Gph[t]**2 /
        #          blk.hot_side.properties_in[t].dens_mass) +
        #         blk.hot_side.properties_in[t].dens_mass *
        ...
        # def rule_deltaP_cold(blk, t):
        #     return blk.cold_side.deltaP[t] == -(
        #         (2*blk.fric_c[t]*(blk.plate_length + blk.port_diameter) *
    ...
    #         return blk.hot_side.properties_in[t].mass_frac_phase_comp['Liq', j] /\
    #             sum(blk.hot_side.properties_in[t].mass_frac_phase_comp['Liq', k]
    ...
    #         return 0.5 * (
    #             blk.hot_side.properties_in[t].cp_mol_phase_comp['Liq', j] /
    #             blk.hot_side.properties_in[t].mw_comp[j] +
    #             blk.hot_side.properties_out[t].cp_mol_phase_comp['Liq', j] /
    #             blk.hot_side.properties_out[t].mw_comp[j])
    ...
    #         return blk.cold_side.properties_in[t].mass_frac_phase_comp['Liq', j] /\
    #             sum(blk.cold_side.properties_in[t].mass_frac_phase_comp['Liq', k]
    #                 for k in solvent_list)
    ...
    #         return 0.5 * (
    #             blk.cold_side.properties_in[t].cp_mol_phase_comp['Liq', j] /
    #             blk.cold_side.properties_in[t].mw_comp[j] +
    #             blk.cold_side.properties_out[t].cp_mol_phase_comp['Liq', j] /
    #             blk.cold_side.properties_out[t].mw_comp[j])
    ...
    #     def rule_Gph(blk, t):
    #         return (4 * blk.hot_side.properties_in[t].flow_mass * 7) /\
    ...
    #     def rule_Gpc(blk, t):
    #         return (4 * blk.cold_side.properties_in[t].flow_mass * 7) /\
    #                (22 * blk.port_diameter**2)
    ...
    #     def rule_Gcc(blk, t):
    #         return blk.cold_side.properties_in[t].flow_mass / \
    #             (blk.Np[1] * blk.plate_width * blk.plate_gap)
    ...
    #         return blk.hot_side.properties_in[t].flow_mass * blk.channel_diameter /\
    #             (blk.Np[p] * blk.plate_width *
    #              blk.plate_gap * blk.hot_side.properties_in[t].visc_d_phase["Liq"])
    ...
    #         return blk.cold_side.properties_in[t].flow_mass * blk.channel_diameter /\
    #             (blk.Np[p] * blk.plate_width *
    #              blk.plate_gap * blk.cold_side.properties_in[t].visc_d_phase["Liq"])
    ...
    #     def rule_Pr_h(blk, t):
    #         return blk.cp_hot[t] * blk.hot_side.properties_in[t].visc_d_phase["Liq"] /\
    ...
    #     def rule_Pr_c(blk, t):
    #         return blk.cp_cold[t] * blk.cold_side.properties_in[t].visc_d_phase["Liq"] /\
    ...
    #         return (blk.cold_side.properties_in[t].therm_cond_phase["Liq"] /
    #                 blk.channel_diameter *
    ...
    #         return blk.hot_side.properties_in[t].flow_mass * blk.cp_hot[t] / blk.Np[p]
    #     self.Caph = Expression(self.flowsheet().time, self.PH,
    #                            rule=rule_Caph,
    #                            doc='Hotfluid capacitance rate')

    #     def rule_Capc(blk, t, p):
    #         return blk.cold_side.properties_in[t].flow_mass * blk.cp_cold[t] / blk.Np[p]
    ...
    #         return blk.hot_side.properties_in[t].flow_mass * blk.cp_hot[t] *\
    #             (blk.hot_side.properties_in[t].temperature -
    #              blk.hot_side.properties_out[t].temperature)
    ...
    #         return blk.cold_side.properties_in[t].flow_mass * blk.cp_cold[t] *\
    #             (blk.cold_side.properties_out[t].temperature -
    #              blk.cold_side.properties_in[t].temperature)
    ...
    #         'mole_frac_comp': hot_side_mole_frac_comp_dict}
    ...
    #         'mole_frac_comp': cold_side_mole_frac_comp_dict}
