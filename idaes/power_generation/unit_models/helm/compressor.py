...
def _assert_properties(pb):
    ...
    try:
        ...
        _log.error("helm.IsentropicCompressor requires a Helmholtz EOS with "
                   "a single or mixed phase and pressure-enthalpy state vars.")
        raise


@declare_process_block_class("IsentropicCompressor")
class IsentropicCompressorData(BalanceBlockData):
    """
    Basic isentropic 0D compressor model.  This inherits the heater block to get
