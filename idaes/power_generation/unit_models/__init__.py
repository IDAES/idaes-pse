...
deprecation_warning(
    "The power_generation.unit_models package has been moved to "
...
from idaes.models_extra.power_generation.unit_models.balance import (
    BalanceBlockData,
    BalanceBlock,
)
...
from idaes.models_extra.power_generation.unit_models.feedwater_heater_0D_dynamic import (
    FWH0DDynamic,
)
