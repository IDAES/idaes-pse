    ...
    def _set_geometry(self):
        ...
        def perimeter_if(b):
            if self.config.single_side_only:
                ...
                return 2*((const.pi-2*b.alpha_tube) * b.radius_out + b.pitch
                          - 2 * b.radius_out * cos(b.alpha_tube))
        ...
        def perimeter_ss(b, t):
            if self.config.single_side_only:
                ...
                return 2 * ((const.pi - 2 * b.alpha_slag[t])
                            * (b.radius_out + b.slag_thickness[t])
    ...
    def _make_performance(self):
        ...
        def friction_factor_darcy_eqn(b, t):
            return Expr_if(b.N_Re[t] < 1187.384, b.friction_factor_darcy[t]
                           * b.N_Re[t]/64.0, b.friction_factor_darcy[t]
                           * b.N_Re[t]**0.25/0.3164) == 1.0
