...
def create_model():
    ...
    ############################################################################
    # Add a mixer for all the streams coming into the condeser.  In this case the
    ...
    # Add the new port with the state infromation that needs to go to the
    # condenser
    ...
    # Add the heat exchaner model for the condneser.
