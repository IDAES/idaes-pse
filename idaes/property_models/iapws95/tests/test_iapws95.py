...
class TestIAPWS95(unittest.TestCase):
    ...
    def test_liquid_density_sat(self):
        model = ConcreteModel()
        model.prop_param = iapws95.Iapws95ParameterBlock()
        model.prop_in = iapws95.Iapws95StateBlock(default={"parameters":model.prop_param})
        cond = self.read_data("sat_prop.txt", col=2)
    ...
    def test_vapor_density_sat(self):
        model = ConcreteModel()
        model.prop_param = iapws95.Iapws95ParameterBlock()
        model.prop_in = iapws95.Iapws95StateBlock(default={"parameters":model.prop_param})
        cond = self.read_data("sat_prop.txt", col=14)
        for c in cond:
            model.prop_in.temperature.set_value(c[0])
            psat = value(model.prop_in.pressure_sat)
            model.prop_in.pressure = psat
    ...
    def test_enthalpy_vapor_as_function_of_p_and_tau(self):
        model = ConcreteModel()
        model.prop_param = iapws95.Iapws95ParameterBlock()
        model.prop_in = iapws95.Iapws95StateBlock(default={"parameters":model.prop_param})
        cond = self.read_data("prop.txt", col=5)
    ...
    def test_enthalpy_liquid_as_function_of_p_and_tau(self):
        model = ConcreteModel()
        model.prop_param = iapws95.Iapws95ParameterBlock()
        model.prop_in = iapws95.Iapws95StateBlock(default={"parameters":model.prop_param})
        cond = self.read_data("prop.txt", col=5)
        rho_dat = self.read_data("prop.txt", col=2)
        phase = self.read_data("prop.txt", col=13)
        for i, c in enumerate(cond):
            p = phase[i][2]
            if p in ["vapor"]:
    ...
    def test_entropy(self):
        ...
        model.prop_param = iapws95.Iapws95ParameterBlock()
        model.prop_in = iapws95.Iapws95StateBlock(default={"parameters":model.prop_param})
        cond = self.read_data("prop.txt", col=6)
        phase = self.read_data("prop.txt", col=13)
        for i, c in enumerate(cond):
            if phase[i][2] in ["liquid", "supercritical"]:
                p = "Liq"
    ...
    def test_speed_of_sound(self):
        ...
        model.prop_param = iapws95.Iapws95ParameterBlock()
        model.prop_in = iapws95.Iapws95StateBlock(default={"parameters":model.prop_param})
        cond = self.read_data("prop.txt", col=9)
        phase = self.read_data("prop.txt", col=13)
        for i, c in enumerate(cond):
            if c[2] == "undefined":
                continue
    ...
    def test_cp(self):
        ...
        model.prop_param = iapws95.Iapws95ParameterBlock()
        model.prop_in = iapws95.Iapws95StateBlock(default={"parameters":model.prop_param})
        cond = self.read_data("prop.txt", col=8)
        phase = self.read_data("prop.txt", col=13)
        for i, c in enumerate(cond):
            if c[2] == "undefined":
                continue
    ...
    def test_cv(self):
        ...
        model.prop_param = iapws95.Iapws95ParameterBlock()
        model.prop_in = iapws95.Iapws95StateBlock(default={"parameters":model.prop_param})
        cond = self.read_data("prop.txt", col=7)
        phase = self.read_data("prop.txt", col=13)
        for i, c in enumerate(cond):
            if c[2] == "undefined":
                continue
