...
class KrigingModelTestCases(unittest.TestCase):
    ...
    def test_error_calculation(self):
        ...
        self.assertEqual(mean_squared_error(KrigingClass.y_data, y_prediction_exp),ss_error)
        self.assertEqual(np.sqrt(mean_squared_error(KrigingClass.y_data, y_prediction_exp)),rmse_error)
