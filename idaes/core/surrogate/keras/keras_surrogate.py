...
#################################################################################
"""
<<<<<<< HEAD:idaes/surrogate/keras/keras_surrogate.py
...
deprecation_warning("The idaes.surrogate.keras_surrogate module has been "
                    "moved to idaes.core.surrogate.keras_surrogate",
                    version="2.0.0.alpha0")

from idaes.core.surrogate.keras_surrogate import *
>>>>>>> main:idaes/surrogate/keras_surrogate.py
