...
class PhysicalPropertiesTestScaler(CustomScalerBase):
    DEFAULT_SCALING_FACTORS = {
        "flow_vol": 1 / 3,
        "flow_mol": 1 / 5,
        "flow_mol_phase_comp": 1 / 7,
        "test_var": 1 / 11,
        "pressure": 1 / 13,
        "temperature": 1 / 17,
        "enth_mol": 1 / 19,
        "gibbs_mol_phase_comp": 1 / 23,
        "entr_mol": 1 / 29,
        "mole_frac_phase_comp": 1 / 31,
        "enthalpy_flow": 1 / 37,
        "energy_dens": 1 / 41,
        "material_flow_mol": 1 / 43,
        "material_dens_mol": 1 / 47,
        "material_flow_mass": 1 / 53,
        "material_dens_mass": 1 / 59,
        "material_flow_dimensionless": 1 / 61,
        "material_dens_dimensionless": 1 / 67,
        "cp_mol": 1 / 71,
    }

    def variable_scaling_routine(self, model, overwrite=False, submodel_scalers=None):
        model.variables_scaled = True
        for var_name in self.default_scaling_factors.keys():
    ...
    def constraint_scaling_routine(self, model, overwrite=False, submodel_scalers=None):
        ...
        # No constraints generated by property model
...
class ReactionTestScaler(CustomScalerBase):
    DEFAULT_SCALING_FACTORS = {"reaction_rate[r1]": 101, "reaction_rate[r2]": 103}
    ...
    def constraint_scaling_routine(self, model, overwrite=False, submodel_scalers=None):
        # No constraints generated by reaction
        model.constraints_scaled = True
...
def assert_solution_equivalent(blk, expected_results):
    ...
    This function was partially generated by Google Gemini 2.5 Pro.
