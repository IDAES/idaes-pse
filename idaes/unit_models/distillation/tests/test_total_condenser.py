...
#     assert number_variables(m.fs.C101_total) == 49
#     assert number_total_constraints(m.fs.C101_total) == 42
#
...
#     assert number_variables(m.fs.C101_total_FcTP) == 51
#     assert number_total_constraints(m.fs.C101_total_FcTP) == 45
#
#     # Fix the partial condenser variables
