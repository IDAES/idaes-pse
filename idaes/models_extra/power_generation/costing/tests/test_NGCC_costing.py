...
def test_units2_costing(build_costing):
    ...
    get_PP_costing(m.fs.b6, CT_grosspower_accounts, m.fs.b6.ct_gross_power, "kW", 6)
    ...
    get_PP_costing(m.fs.b8, Stack_flow_gas_accounts, m.fs.b8.stack_flow_gas, "acfm", 6)
...
def test_units3_costing(build_costing):
    ...
    get_PP_costing(
        m.fs.b9, Steam_turbine_gross_power_accounts, m.fs.b9.st_gross_power, "kW", 6
    )
    ...
    get_PP_costing(m.fs.b13, plant_gross_power_accounts, m.fs.b13.gross_power, "kW", 6)
    ...
    get_PP_costing(
        m.fs.b14, auxilliary_load_accounts, m.fs.b14.auxilliary_load, "kW", 6
    )
    ...
    get_PP_costing(m.fs.b15, stg_ctg_accounts, m.fs.b15.stg_ctg_output, "kW", 6)
    ...
    get_PP_costing(m.fs.b16, gasturbine_accounts, m.fs.b16.gas_turbine_power, "kW", 6)
