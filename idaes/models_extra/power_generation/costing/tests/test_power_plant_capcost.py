...
def test_PP_costing():
    ...
    QGESSCostingData.get_PP_costing(
        m.fs.fuel_feed, fuel_accounts, m.fs.fuel_feed.total_fuel_feed, "lb/hr", 2
    )
    ...
    m.fs.turb.power.fix()
    QGESSCostingData.get_PP_costing(m.fs.turb, power_accounts, m.fs.turb.power, "kW", 2)
    ...
    QGESSCostingData.get_PP_costing(
        m.fs.ash_handling, ash_accounts, m.fs.ash_handling.ash_mass_flow, "lb/hr", 2
    )
    ...
    assert (
        pytest.approx(pyo.value(m.fs.boiler.total_plant_cost["1.1"]), abs=1e-1)
        == 2306 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.boiler.total_plant_cost["1.2"]), abs=1e-1)
        == 6385 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.boiler.total_plant_cost["1.3"]), abs=1e-1)
        == 59527 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.boiler.total_plant_cost["1.4"]), abs=1e-1)
        == 8086 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.boiler.total_plant_cost["2.1"]), abs=1e-1)
        == 4073 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.boiler.total_plant_cost["2.2"]), abs=1e-1)
        == 13976 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.boiler.total_plant_cost["4.11"]), abs=1e-1)
        == 3751 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.boiler.total_plant_cost["4.15"]), abs=1e-1)
        == 197 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.boiler.total_plant_cost["4.16"]), abs=1e-1)
        == 1014 / 1e3
    )
    ...
    assert (
        pytest.approx(pyo.value(m.fs.bfp.total_plant_cost["3.1"]), abs=1e-1)
        == 19233 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.bfp.total_plant_cost["3.3"]), abs=1e-1)
        == 6897 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.bfp.total_plant_cost["3.5"]), abs=1e-1)
        == 2366 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.bfp.total_plant_cost["4.9"]), abs=1e-1)
        == 570418 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.bfp.total_plant_cost["8.4"]), abs=1e-1)
        == 81916 / 1e3
    )

    assert (
        pytest.approx(pyo.value(m.fs.turb.total_plant_cost["8.1"]), abs=1e-1)
        == 110166 / 1e3
    )
    ...
    assert (
        pytest.approx(
            pyo.value(m.fs.circulating_water.total_plant_cost["9.2"]), abs=1e-1
        )
        == 4133 / 1e3
    )
    assert (
        pytest.approx(
            pyo.value(m.fs.circulating_water.total_plant_cost["9.3"]), abs=1e-1
        )
        == 25518 / 1e3
    )
    assert (
        pytest.approx(
            pyo.value(m.fs.circulating_water.total_plant_cost["9.4"]), abs=1e-1
        )
        == 19859 / 1e3
    )
    assert (
        pytest.approx(
            pyo.value(m.fs.circulating_water.total_plant_cost["9.6"]), abs=1e-1
        )
        == 2870 / 1e3
    )
    assert (
        pytest.approx(
            pyo.value(m.fs.circulating_water.total_plant_cost["9.7"]), abs=1e-1
        )
        == 2690 / 1e3
    )
    assert (
        pytest.approx(
            pyo.value(m.fs.circulating_water.total_plant_cost["14.5"]), abs=1e-1
        )
        == 464 / 1e3
    )
...
def test_power_plant_costing():
    ...
    QGESSCostingData.get_PP_costing(
        m.fs.IGCC_1, feedwater_accounts, m.fs.IGCC_1.feedwater_flow_rate, "lb/hr", 3
    )
    ...
    QGESSCostingData.get_PP_costing(
        m.fs.IGCC_2, syngas_accounts, m.fs.IGCC_2.syngas_flow_rate, "lb/hr", 4
    )
    ...
    assert (
        pytest.approx(pyo.value(m.fs.IGCC_1.total_plant_cost["3.1"]), abs=1e-1)
        == 10807 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.IGCC_1.total_plant_cost["3.3"]), abs=1e-1)
        == 2564 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.IGCC_1.total_plant_cost["3.5"]), abs=1e-1)
        == 923 / 1e3
    )

    assert (
        pytest.approx(pyo.value(m.fs.IGCC_2.total_plant_cost["6.1"]), abs=1e-1)
        == 117850 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.IGCC_2.total_plant_cost["6.2"]), abs=1e-1)
        == 3207 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.IGCC_2.total_plant_cost["6.3"]), abs=1e-1)
        == 3770 / 1e3
    )

    assert (
        pytest.approx(pyo.value(m.fs.IGCC_3.total_plant_cost["7.1"]), abs=1e-1)
        == 53530 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.IGCC_3.total_plant_cost["7.2"]), abs=1e-1)
        == 19113 / 1e3
    )

    assert (
        pytest.approx(pyo.value(m.fs.NGCC.total_plant_cost["8.1"]), abs=1e-1)
        == 49468 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.NGCC.total_plant_cost["8.2"]), abs=1e-1)
        == 565 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.NGCC.total_plant_cost["8.5"]), abs=1e-1)
        == 4094 / 1e3
    )

    assert (
        pytest.approx(pyo.value(m.fs.AUSC.bare_erected_cost["4.9"]), abs=1e-1)
        == 295509 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.AUSC.bare_erected_cost["8.4"]), abs=1e-1)
        == 57265 / 1e3
    )
...
def test_sCO2_costing():
    ...
    QGESSCostingData.get_sCO2_unit_cost(
        m.fs.generator, "Generator", m.fs.turbine.work_isentropic * (1e-6), n_equip=1
    )
    ...
    QGESSCostingData.get_sCO2_unit_cost(
        m.fs.co2_cooler, "Recuperator", m.fs.co2_cooler.UA, temp_C=m.fs.co2_cooler.temp
    )
    ...
    assert (
        pytest.approx(pyo.value(m.fs.HTR.costing.equipment_cost), abs=1e-1)
        == 40150 / 1e3
    )
    assert (
        pytest.approx(pyo.value(m.fs.LTR.costing.equipment_cost), abs=1e-1)
        == 81860 / 1e3
    )
    assert (
...
def test_ASU_costing():
    ...
    QGESSCostingData.get_ASU_cost(m.fs.ASU, m.fs.ASU.O2_flow)
    ...
    assert (
        pytest.approx(pyo.value(m.fs.ASU.costing.bare_erected_cost), abs=1)
        == 3.2675e6 / 1e3
    )
...
def test_OM_costing():
    ...
    m.fs.H2_prod = pyo.Var(m.fs.time, initialize=100000, units=pyunits.kg / pyunits.day)
    m.fs.H2_prod.fix()
