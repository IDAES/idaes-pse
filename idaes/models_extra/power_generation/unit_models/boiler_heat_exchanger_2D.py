...
tube side flows from 1 to 0""",
    ...
    def _make_performance(self):
        ...
        def friction_factor_tube_eqn(b, t, x):
            return (
                b.tube_friction_factor[t, x] * smooth_max(b.tube_N_Re[t, x], 1, 1e-5) ** 0.25
        ...
        def N_Nu_tube_eqn(b, t, x):
            return (
                b.tube_N_Nu[t, x]
                == 0.023 * smooth_max(b.tube_N_Re[t, x], 1, 1e-5) ** 0.8 * b.tube_N_Pr[t, x] ** 0.4
            )
        ...
        if self.config.tube_arrangement == "in-line":
            ...
            def friction_factor_shell_eqn(b, t, x):
                return (
                    b.shell_friction_factor[t, x] * smooth_max(b.shell_N_Re[t, x], 1, 1e-5) ** 0.15
                    == (
                        0.044
                        + 0.08
                        * b.pitch_x_to_do
            ...
            def friction_factor_shell_eqn(b, t, x):
                return (
                    b.shell_friction_factor[t, x] * smooth_max(b.shell_N_Re[t, x], 1, 1e-5) ** 0.16
    ...
    def initialize_build(
        ...
        with idaeslog.solver_log(solve_log, idaeslog.DEBUG) as slc:
            res = opt.solve(blk, tee=slc.tee, options={"halt_on_ampl_error":"yes"}, symbolic_solver_labels=True)
