...
vapor_flow_expected_results = {
    "bottoms.flow_mol[0]": (74.33, _rel, _abs),
    "bottoms.mole_frac_comp[0, CO2]": (0.0285221, _rel, _abs),
    "bottoms.mole_frac_comp[0, MEA]": (0.122455, _rel, _abs),
    "bottoms.mole_frac_comp[0, H2O]": (0.849023, _rel, _abs),
    "bottoms.pressure[0]": (183700, _rel, _abs),
    "bottoms.temperature[0]": (393.773, _rel, _abs),
    "vapor_reboil.flow_mol[0]": (9.56, _rel, _abs),
    "vapor_reboil.mole_frac_comp[0, CO2]": (0.0643063, _rel, _abs),
    "vapor_reboil.mole_frac_comp[0, H2O]": (0.935693, _rel, _abs),
    "vapor_reboil.mole_frac_comp[0, N2]": (0, None, 1e-8),
    "vapor_reboil.mole_frac_comp[0, O2]": (0, None, 1e-8),
    "vapor_reboil.pressure[0]": (183700, _rel, _abs),
    "vapor_reboil.temperature[0]": (393.773, _rel, _abs),
    "unit.heat_duty[0]": (420983, _rel, _abs)
}

heat_duty_expected_results = {
    "bottoms.flow_mol[0]": (74.1048, _rel, _abs),
    "bottoms.mole_frac_comp[0, CO2]": (0.0285059, _rel, _abs),
    "bottoms.mole_frac_comp[0, MEA]": (0.122827, _rel, _abs),
    "bottoms.mole_frac_comp[0, H2O]": (0.848667, _rel, _abs),
    "bottoms.pressure[0]": (183700, _rel, _abs),
    "bottoms.temperature[0]": (393.810, _rel, _abs),
    "vapor_reboil.flow_mol[0]": (9.7852, _rel, _abs),
    "vapor_reboil.mole_frac_comp[0, CO2]": (0.063605, _rel, _abs),
    "vapor_reboil.mole_frac_comp[0, H2O]": (0.936395, _rel, _abs),
    "vapor_reboil.mole_frac_comp[0, N2]": (0, None, 1e-8),
    "vapor_reboil.mole_frac_comp[0, O2]": (0, None, 1e-8),
    "vapor_reboil.pressure[0]": (183700, _rel, _abs),
    "vapor_reboil.temperature[0]": (393.810, _rel, _abs),
}
...
# -----------------------------------------------------------------------------
@pytest.mark.parametrize("initialization_method", [call_initialization_old_API, call_initialization_new_API])
@pytest.mark.parametrize("specification_type", [vapor_flow_specification, heat_duty_specification])
class TestAbsorber(object):
    ...
    def test_solution(self, initialization_method, specification_type, model):
        assert_solution_equivalent(model.fs.unit, specification_type["expected_results"])
