...
def clean_variable_name(theta_names):
    ...
    -------
        ...
        - theta_names_out(list of strings) : List of Var names after removing  
        all ' and spaces
        - var_dic(dict): Dictionary with keys converted theta_names and values 
        origianl theta_names 
    """   
