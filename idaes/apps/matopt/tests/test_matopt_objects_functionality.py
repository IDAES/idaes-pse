...
@pytest.mark.unit
def test_functionality_FCCLattice(test_construct_FCCLattice):
...
@pytest.mark.unit
def test_functionality_CubicLattice(test_construct_CubicLattice):
...
@pytest.mark.unit
def test_functionality_DiamondLattice(test_construct_DiamondLattice):
...
@pytest.mark.unit
def test_functionality_WurtziteLattice(test_construct_WurtziteLattice):
