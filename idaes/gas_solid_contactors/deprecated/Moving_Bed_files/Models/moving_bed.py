...
**"FORWARD""** - use a collocation transformation method,
...
see reaction package for documentation.}"""))
    ...
    # =========================================================================
        ...
        self.gas_phase.add_state_blocks(
            ...
            has_phase_equilibrium=self.config.gas_phase_config.
    ...
    # =========================================================================
        ...
        if self.config.solid_phase_config.reaction_package is not None:
            self.config.solid_phase_config.reaction_package_args = \
                {"gas_state_block": self.gas_phase.properties}
        ...
        self.solid_phase.add_state_blocks(
            ...
            has_phase_equilibrium=self.config.solid_phase_config.
            has_phase_equilibrium)

        if self.config.solid_phase_config.reaction_package is not None:
            self.solid_phase.add_reaction_blocks(
                    has_equilibrium=self.config.solid_phase_config.
                    has_equilibrium_reactions)
...
#        """
        ...
        if blk.config.gas_phase_config.reaction_package is not None:
            ...
            blk.gas_phase.reactions.initialize(outlvl=outlvl - 1,
                                               optarg=optarg,
                                               solver=solver)
        ...
        if blk.config.solid_phase_config.reaction_package is not None:
            ...
            blk.solid_phase.reactions.initialize(outlvl=outlvl - 1,
                                                 optarg=optarg,
                                                 solver=solver)
