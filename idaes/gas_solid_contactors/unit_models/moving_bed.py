    ...
    # =========================================================================
        ...
        if self.config.energy_balance_type == EnergyBalanceType.none:
            for t in self.flowsheet().config.time:
                for x in self.gas_phase.length_domain:
                    self.gas_phase.properties[t, x].temperature.fix(
                            value(self.gas_inlet.temperature[t]))
                for x in self.solid_phase.length_domain:
                    self.solid_phase.properties[t, x].temperature.fix(
                            value(self.solid_inlet.temperature[t]))
