...
class PhysicalParameterData(PhysicalParameterBlock):
    ...
    def build(self):
        ...
        visc_d_param_dict = {('CH4', 1): 5.2546e-7, ('CH4', 2): 0.59006,
                             ...
                             ('H2O', 3): 0, ('H2O', 4): 0,
                             ('CO', 1): 1.11e-6, ('CO', 2): 0.5338,
                             ('CO', 3): 94.7, ('CO', 4): 0,
                             ('H2', 1): 1.8e-7, ('H2', 2): 0.685,
                             ('H2', 3): -0.59, ('H2', 4): 140}
        ...
        therm_cond_param_dict = {('CH4', 1): 8.3983e-6, ('CH4', 2): 1.4268,
                                 ...
                                 ('H2O', 3): 0, ('H2O', 4): 0,
                                 ('CO', 1): 0.00059882, ('CO', 2): 0.6863,
                                 ('CO', 3): 57.13, ('CO', 4): 501.92,
                                 ('H2', 1): 0.002653, ('H2', 2): 0.7452,
                                 ('H2', 3): 12, ('H2', 4): 0}
    ...
    def define_metadata(cls, obj):
        obj.add_properties({
            ...
            'dens_mole_vap': {'method': '_dens_mole_vap', 'units': 'mol/m^3'},
            'dens_mole_comp_vap': {'method': '_dens_mole_comp_vap',
                                   'units': 'mol/m^3'},
            'dens_mass_vap': {'method': '_dens_mass_vap', 'units': 'kg/m^3'},
...
class Gas_Phase_Thermo_StateBlockData(StateBlockData):
    ...
    def _diffusion_comp(self):
        ...
        def D_bin(i, j):
            ...
            return ((1.43e-3*(((self.temperature**2 +
                                self._params._eps)**0.5)**1.75) *
    ...
    def _therm_cond(self):
        ...
        def A_bin(i, j):
            return (1 + ((((therm_cond_comp(j)/therm_cond_comp(i))**2 +
                           self._params._eps)**2)**0.5)
