...
##############################################################################
"""
Property package for the heterogeneous reaction of CH4, CO, and H2 with an
iron-based OC. Overall reducer reactions for combustion:
    (R1) CH4 + 12Fe2O3 => 8Fe3O4 + CO2 + 2H2O
    (R2) CO  + 3Fe2O3  => 2Fe3O4 + CO2
    (R3) H2  + 3Fe2O3  => 2Fe3O4 + H2O
"""
...
__author__ = "Anca Ostace and Chinedu Okoli"
...
**False** - exclude equilibrium reaction terms.}"""))
    ...
    def _OC_conv(self):
        ...
        def OC_conv_eqn(b):
            return 1e6*b.OC_conv*(b.solid_state_ref.mass_frac['Fe3O4'] +
    ...
    def _reaction_rate(self):
        ...
        def rate_rule(b, r):
            if r == "R1":
                return b.reaction_rate[r]*1e4 == b._params._scale_factor_rxn*(
                    1e4*b.solid_state_ref.mass_frac['Fe2O3'] *
                    ...
                    (((b.gas_state_ref.dens_mole_comp_vap['CH4'] ** 2 +
                       b._params._eps**2)**0.5)**b._params.rxn_order[r]) *
                ...
                return b.reaction_rate[r]*1e4 == b._params._scale_factor_rxn*(
                    ...
                    (b._params.a_vol/(b.solid_state_ref._params.mw['Fe2O3'])) *
                    3*b._params.rxn_stoich_coeff[r]*b.k_rxn[r] *
                    (((b.gas_state_ref.dens_mole_comp_vap['CO'] ** 2 +
                       b._params._eps**2)**0.5)**b._params.rxn_order[r]) *
                    b.OC_conv_temp/(b._params.dens_mol_sol *
                                    b._params.grain_radius) /
                    (-b._params.rate_reaction_stoichiometry['R2', 'Sol',
                                                            'Fe2O3']))
            else:
                return b.reaction_rate[r]*1e4 == b._params._scale_factor_rxn*(
                    1e4*b.solid_state_ref.mass_frac['Fe2O3'] *
                    ...
                    (b._params.a_vol/(b.solid_state_ref._params.mw['Fe2O3'])) *
                    3*b._params.rxn_stoich_coeff[r]*b.k_rxn[r] *
                    (((b.gas_state_ref.dens_mole_comp_vap['H2']**2 +
                       b._params._eps**2)**0.5)**b._params.rxn_order[r]) *
                    b.OC_conv_temp/(b._params.dens_mol_sol *
                                    b._params.grain_radius) /
                    (-b._params.rate_reaction_stoichiometry['R3', 'Sol',
                                                            'Fe2O3']))
