...
#                                         '[kg/m3]')
        ...
        self.dens_mass_comp_sol = Param(
            ...
            doc='Particle density of solid components [kg/m3]')
    ...
    def define_metadata(cls, obj):
        obj.add_properties({
            ...
            'dens_mass_sol': {'method': '_dens_mass_sol', 'units': 'kg/m3'},
...
class Solid_Phase_Thermo_StateBlockData(StateBlockData):
    ...
    def _dens_mass_sol(self):
        ...
        try:
            ...
            self.density_constraint = Constraint(rule=density_constraint)
