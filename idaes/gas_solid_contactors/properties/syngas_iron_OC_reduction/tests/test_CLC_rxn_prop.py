...
def test_solve():
    ...
    # (reactant gas species density, solid density,
    # temperature and component fractions)
    m.reaction_block.gas_state_ref.dens_mole_comp_vap['CH4'].fix(10)
    m.reaction_block.gas_state_ref.dens_mole_comp_vap['CO'].fix(10)
    m.reaction_block.gas_state_ref.dens_mole_comp_vap['H2'].fix(10)
