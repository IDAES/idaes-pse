...
def test_setInputs_state_block():
    ...
    m.state_block.mass_frac["Fe2O3"].fix(0.244162011502)
    m.state_block.mass_frac["Fe3O4"].fix(0.201998299487)
    m.state_block.mass_frac["Al2O3"].fix(0.553839689011)
...
def test_solve():
    ...
    assert value(m.state_block.mass_frac['Fe2O3']) == \
        pytest.approx(0.24416, abs=1e-3)
