...
def test_solve():
    ...
    m.reaction_block.gas_state_ref.dens_mole_comp_vap['O2'].fix(10)
    ...
    m.reaction_block.solid_state_ref.mass_frac["Fe2O3"].fix(0.244162011502)
    m.reaction_block.solid_state_ref.mass_frac["Fe3O4"].fix(0.201998299487)
    m.reaction_block.solid_state_ref.mass_frac["Al2O3"].fix(0.553839689011)
