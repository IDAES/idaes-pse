...
class PhysicalParameterData(PhysicalParameterBlock):
    ...
    def build(self):
        ...
        self.smooth_abs_param = Param(
                initialize=1e-8,
                doc="Parameter for constructing smooth absolute values",
                )
...
class Gas_Phase_Thermo_StateBlockData(StateBlockData):
    ...
    def _visc_d(self):
        ...
        def visc_d_comp(i):
            return self._params.visc_d_param[i, 1] * \
                    ( ((self.temperature**2 + 
                        self._params.smooth_abs_param)**0.5)
    ...
    def _diffusion_comp(self):
        ...
        def D_bin(i, j):
            ...
            return ((1.43e-3*( 
                ((self.temperature**2 + self._params.smooth_abs_param)*0.5)
                     **1.75) *
