...
class PipeScaler(CustomScalerBase):
    """
    Default modular scaler for Pipe unit models.
    ...
    def variable_scaling_routine(
        ...
        # In the Pipe, the area is always constant---the option to make area
...
@declare_process_block_class("Pipe")
class PipeData(UnitModelBlockData):
    """
    Standard Pipe Unit Model Class
    """

    default_scaler = PipeScaler
