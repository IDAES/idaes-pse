...
class TestBTExample(object):
    ...
    def test_units(self):
        ...
        m.fs.state = m.fs.props.build_state_block(default={"defined_state": True})
    ...
    def test_T350_P1_x5(self):
        ...
        assert (
            pytest.approx(
                value(m.fs.state.fug_coeff_phase_comp["Liq", "benzene"]), 1e-5
            )
            == 0.894676
        )
        assert (
            pytest.approx(
                value(m.fs.state.fug_coeff_phase_comp["Liq", "toluene"]), 1e-5
            )
            == 0.347566
        )
        assert (
            pytest.approx(
                value(m.fs.state.fug_coeff_phase_comp["Vap", "benzene"]), 1e-5
            )
            == 0.971072
        )
        assert (
            pytest.approx(
                value(m.fs.state.fug_coeff_phase_comp["Vap", "toluene"]), 1e-5
            )
            == 0.959791
        )
        ...
        assert (
            pytest.approx(
                value(m.fs.state.mole_frac_phase_comp["Liq", "benzene"]), 1e-5
            )
            == 0.5
        )
        assert (
            pytest.approx(
                value(m.fs.state.mole_frac_phase_comp["Liq", "toluene"]), 1e-5
            )
            == 0.5
        )
        assert (
            pytest.approx(
                value(m.fs.state.mole_frac_phase_comp["Vap", "benzene"]), 1e-5
            )
            == 0.70584
        )
        assert (
            pytest.approx(
                value(m.fs.state.mole_frac_phase_comp["Vap", "toluene"]), 1e-5
            )
            == 0.29416
        )

        assert pytest.approx(value(m.fs.state.enth_mol_phase["Liq"]), 1e-5) == 38942.8
        assert pytest.approx(value(m.fs.state.enth_mol_phase["Vap"]), 1e-5) == 78048.7
        assert pytest.approx(value(m.fs.state.entr_mol_phase["Liq"]), 1e-5) == -367.558
        assert pytest.approx(value(m.fs.state.entr_mol_phase["Vap"]), 1e-5) == -269.0553
    ...
    def test_T350_P5_x5(self):
        ...
        assert (
            pytest.approx(value(m.fs.state.compress_fact_phase["Liq"]), 1e-5) == 0.01766
        )
        assert (
            pytest.approx(value(m.fs.state.compress_fact_phase["Vap"]), 1e-5) == 0.80245
        )
        assert (
            pytest.approx(
                value(m.fs.state.fug_coeff_phase_comp["Liq", "benzene"]), 1e-5
        ...
        assert pytest.approx(value(m.fs.state.enth_mol_phase["Liq"]), 1e-5) == 38966.9
        assert pytest.approx(value(m.fs.state.enth_mol_phase["Vap"]), 1e-5) == 75150.7
        assert pytest.approx(value(m.fs.state.entr_mol_phase["Liq"]), 1e-5) == -367.6064
        assert pytest.approx(value(m.fs.state.entr_mol_phase["Vap"]), 1e-5) == -287.3318
    ...
    def test_T450_P1_x5(self):
        ...
        assert pytest.approx(value(m.fs.state.enth_mol_phase["Liq"]), 1e-5) == 49441.2
        assert pytest.approx(value(m.fs.state.enth_mol_phase["Vap"]), 1e-5) == 84175.1
        assert pytest.approx(value(m.fs.state.entr_mol_phase["Liq"]), 1e-5) == -333.836
        assert pytest.approx(value(m.fs.state.entr_mol_phase["Vap"]), 1e-5) == -247.385
    ...
    def test_T450_P5_x5(self):
        ...
        assert pytest.approx(value(m.fs.state.enth_mol_phase["Liq"]), 1e-5) == 51095.2
        assert pytest.approx(value(m.fs.state.enth_mol_phase["Vap"]), 1e-5) == 83362.3
        assert pytest.approx(value(m.fs.state.entr_mol_phase["Liq"]), 1e-5) == -331.676
        assert pytest.approx(value(m.fs.state.entr_mol_phase["Vap"]), 1e-5) == -261.961
    ...
    def test_T368_P1_x5(self):
        ...
        assert 0.97 == pytest.approx(value(m.fs.state.compress_fact_phase["Vap"]), 1e-5)
        assert (
            pytest.approx(
                value(m.fs.state.fug_coeff_phase_comp["Liq", "benzene"]), 1e-5
            )
        ...
        assert pytest.approx(value(m.fs.state.enth_mol_phase["Liq"]), 1e-5) == 38235.1
        assert pytest.approx(value(m.fs.state.enth_mol_phase["Vap"]), 1e-5) == 77155.4
        assert pytest.approx(value(m.fs.state.entr_mol_phase["Liq"]), 1e-5) == -364.856
        assert pytest.approx(value(m.fs.state.entr_mol_phase["Vap"]), 1e-5) == -267.892
    ...
    def test_T376_P1_x2(self):
        ...
        assert pytest.approx(value(m.fs.state.enth_mol_phase["Liq"]), 1e-5) == 31535.8
        assert pytest.approx(value(m.fs.state.enth_mol_phase["Vap"]), 1e-5) == 69175.3
        assert pytest.approx(value(m.fs.state.entr_mol_phase["Liq"]), 1e-5) == -372.869
        assert pytest.approx(value(m.fs.state.entr_mol_phase["Vap"]), 1e-5) == -278.766
