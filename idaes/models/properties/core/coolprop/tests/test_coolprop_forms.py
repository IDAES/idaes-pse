...
import idaes.models.properties.core.coolprop.coolprop_forms as cforms
...
class TestBaseForms:
    ...
    def test_expression_exponential_tau(self, model):
        model.params.pressure_crit = Var(initialize=5043000,
                                         units=pyunits.Pa)
        model.params.temperature_crit = Var(initialize=154.581,
                                            units=pyunits.K)
