...
class IdealBubbleDewScaler(CustomScalerBase):
    ...
    def variable_scaling_routine(
        self, model, phase, overwrite: bool = False
    ):
        pass
    ...
    def constraint_scaling_routine(
        ...
        for pp in model.params._pe_pairs:
                ...
                if len(v_only_comps) == 0 and model.is_property_constructed("eq_temperature_bubble"):
                    self.set_component_scaling_factor(
                        model.eq_temperature_bubble[pp[0], pp[1]],
                        sf_P,
                        overwrite=overwrite
                    )
                ...
                if len(l_only_comps) == 0 and model.is_property_constructed("eq_temperature_dew"):
                    # eq_temperature_dew is well-scaled by default
                    self.set_component_scaling_factor(
                        model.eq_temperature_dew[pp[0], pp[1]],
                        1,
                        overwrite=overwrite
                    )
                    for j in model.component_list:
                ...
                if len(v_only_comps) == 0 and model.is_property_constructed("eq_pressure_bubble"):
                    self.set_component_scaling_factor(
                        model.eq_pressure_bubble[pp[0], pp[1]],
                        sf_P,
                        overwrite=overwrite
                    )
                    for j in model.component_list:
                ...
                if len(l_only_comps) == 0 and model.is_property_constructed("eq_pressure_dew"):
                    # eq_pressure_dew is well-scaled by default
                    self.set_component_scaling_factor(
                        model.eq_pressure_dew[pp[0], pp[1]],
                        1,
                        overwrite=overwrite
                    )                    
                    for j in model.component_list:
        ...
        for pp in model.params._pe_pairs:
            ...
            if len(l_only_comps) == 0 and model.is_property_constructed("eq_pressure_dew"):
                ...
                for j in model.component_list:
                    ...
                    # equation to zero.
                    self.set_component_scaling_factor(
                        model.eq_pressure_dew[pp[0], pp[1], j],
                        1,
                        overwrite=overwrite
                    )
