...
class TestApparentSpeciesBasisNoInherentLegacyScaling:
    ...
    def frame(self):
        ...
        m.fs.props = GenericParameterBlock(**self.config)
...
# -----------------------------------------------------------------------------
class TestTrueSpeciesBasisNoInherentLegacyScaling:
    config = get_config_no_inherent_reactions()
...
# -----------------------------------------------------------------------------
class TestTrueSpeciesBasisInherentLegacyScaling:
    config = get_config_with_inherent_reactions()
    config["state_components"] = StateIndex.true
    config["state_definition"] = FTPx
    config["state_bounds"] = deepcopy(state_bounds)
...
# -----------------------------------------------------------------------------
class TestApparentSpeciesBasisInherentIdealLegacyScaling:
    config = get_config_with_inherent_reactions()
    config["state_components"] = StateIndex.apparent
    config["state_definition"] = FTPx
    config["state_bounds"] = deepcopy(state_bounds)
    config["phases"]["Liq"]["equation_of_state"] = Ideal
...
# -----------------------------------------------------------------------------
class TestTrueSpeciesBasisInherentIdealLegacyScaling:
    config = get_config_with_inherent_reactions()
    config["state_components"] = StateIndex.true
    config["state_definition"] = FTPx
    config["state_bounds"] = deepcopy(state_bounds)
    config["phases"]["Liq"]["equation_of_state"] = Ideal
    config["default_scaling_factors"] = {
...
# Scaler objects
# -----------------------------------------------------------------------------
class TestApparentSpeciesBasisNoInherentScalerObject:
    config = get_config_no_inherent_reactions()
    config["state_components"] = StateIndex.apparent
    config["state_definition"] = FTPx
    config["state_bounds"] = deepcopy(state_bounds)
...
class TestApparentSpeciesBasisInherentScalerObject:
    ...
    def test_solve_for_true_species(self, frame):
        ...
        assert value(
            m.fs.state[1].mole_frac_phase_comp_true["Liq", "CO3--"]
        ) == pytest.approx(0.142809, rel=1e-3)
        assert value(
            m.fs.state[1].mole_frac_phase_comp_true["Liq", "H+"]
        ) == pytest.approx(2.90081e-16, rel=1e-3)
        assert value(
            m.fs.state[1].mole_frac_phase_comp_true["Liq", "H2O"]
        ) == pytest.approx(0.571429, rel=1e-3)
        assert value(
            m.fs.state[1].mole_frac_phase_comp_true["Liq", "HCO3-"]
        ) == pytest.approx(1.13961e-08, rel=1e-3)
        assert value(
            m.fs.state[1].mole_frac_phase_comp_true["Liq", "K+"]
        ) == pytest.approx(0.285714, rel=1e-3)
        assert value(
            m.fs.state[1].mole_frac_phase_comp_true["Liq", "OH-"]
...
# -----------------------------------------------------------------------------
class TestTrueSpeciesBasisNoInherentScalerObject:
    config = get_config_no_inherent_reactions()
    config["state_components"] = StateIndex.true
    config["state_definition"] = FTPx
    config["state_bounds"] = deepcopy(state_bounds)
...
# -----------------------------------------------------------------------------
class TestTrueSpeciesBasisInherentScalerObject:
    config = get_config_with_inherent_reactions()
    config["state_components"] = StateIndex.true
    config["state_definition"] = FTPx
    config["state_bounds"] = deepcopy(state_bounds)
...
# -----------------------------------------------------------------------------
class TestApparentSpeciesBasisInherentIdealScalerObject:
    config = get_config_with_inherent_reactions()
    config["state_components"] = StateIndex.apparent
    config["state_definition"] = FTPx
    config["state_bounds"] = deepcopy(state_bounds)
...
# -----------------------------------------------------------------------------
class TestTrueSpeciesBasisInherentIdealScalerObject:
    config = get_config_with_inherent_reactions()
    config["state_components"] = StateIndex.true
    config["state_definition"] = FTPx
    config["state_bounds"] = deepcopy(state_bounds)
    ...
    def frame(self):
        ...
        scaler_obj = m.fs.state.default_scaler()
        scaler_obj.default_scaling_factors["flow_mol_phase"] = 1
        scaler_obj.default_scaling_factors["mole_frac_comp[OH-]"] = 1e8
        scaler_obj.default_scaling_factors["mole_frac_comp[HCO3-]"] = 1e8
        scaler_obj.default_scaling_factors["mole_frac_comp[H+]"] = 1e16
        scaler_obj.scale_model(m.fs.state[1])
