...
from idaes.models.properties.examples.methanol_ideal_vapor import config_dict
...
class TestParamBlock(object):
    ...
    def test_build(self):
        ...
        for i in model.params.phase_list:
            assert i == 'Vap'  # should be only phase present
...
class TestStateBlock(object):
    ...
    def test_solution(self, model):
        # Check phase equilibrium results (only  vapor, so only one phase)
