...
:ref:`StateBlocks <technical_specs/core/physical_property_class:State Blocks>` - one for the incoming material and one for 
the material within and leaving the volume - and one 
:ref:`StateBlocks <technical_specs/core/reaction_property_class:Reaction Blocks>`.
