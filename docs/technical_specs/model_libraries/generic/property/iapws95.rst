...
(subheadings could be more streamlined in documentation reorganization:
description, example, degrees of freedom, construction arguments, variables, 
constraints, references, autogenerated class)
...
The Heater unit model example (broken link) for using water properties.
...
the StateBlock documentation (broken link).
...
can be called by AMPL solvers.  See the installation (broken link) page for
...
section :ref:`ExternalFunctions <technical_specs/model_libraries/generic/property/iapws95:ExternalFunctions>`.
...
:ref:`class reference <technical_specs/model_libraries/generic/property/iapws95:Iapws95ParameterBlock Class>` for details
