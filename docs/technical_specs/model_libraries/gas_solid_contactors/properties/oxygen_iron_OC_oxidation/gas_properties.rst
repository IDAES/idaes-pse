...
.. csv-table::
   ...
   "``visc_d_param``", ":math:`\mu_{param,j,i}`", "Viscosity parameters indexed by component list and viscosity list",  , "[3]"
   "``therm_cond_param``", ":math:`k_{param,j,i}`", "Thermal conductivity parameters indexed by component list and thermal conductivity list",  , "[3]"   
...
.. math:: 1 = \sum_j{x_{j}}
* Diffusion of component in a multicomponent gas mixture, see reference [3]
...
* Mixture dynamic viscosity, see reference [3]
...
* Thermal conductivity, see reference [3]
