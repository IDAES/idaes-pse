...
.. warning::
  RIPE was removed from the IDAES codebase in v2.1 due to a lack of use and maintenance (3/9/2023, previous hash: 653fdcc). RIPE can be found in older releases if required, and maybe restored if suffiicent interest is shown and a maintainer can be identified (see https://github.com/IDAES/idaes-pse/wiki/Maintenance-and-Testing-of-User-Supported-Code)
