...
2. Define the :ref:`rate-based reactions<advanced_user_guide/property_development/general_reactions/rate_rxns:Defining Rate-Based Reactions>` of interest in the system.
3. Define the :ref:`equilibrium-based reactions<advanced_user_guide/property_development/general_reactions/equil_rxns:Defining Equilibrium Reactions>` of interest in the system. Nore that phase equilibrium is generally handled in the thermodynamic property package.
