...
The same set of guidelines for defining thermophysical properties apply to reaction properties, :ref:`which can be found here<how_to_guides/custom_models/property_package_development:State Variables and Properties>`.
...
Tutorials demonstrating how to create custom reaction packages are being developed. Once they are created, they will be found :ref:`here<tutorials/tutorials_examples:Tutorials and Examples>`.
