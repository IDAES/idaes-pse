...
The role of the :ref:`ReactionParameterBlock Class<reference_guides/core/reaction_property_class:ReactionParameterBlock Class>`
is to set up the references required by the rest of the IDAES framework for constructing
instances of :ref:`ReactionBlocks<explanations/components/property_package/reaction_block:Reaction Block>`
