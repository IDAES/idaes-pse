...
.. math:: - \frac{ \delta P }{ \delta z } = \frac{ 150 \mu_{g} {\left 1 - \epsilon \right}^{2} \left u_{g} + u_{s} \right }{ \epsilon^{3} d_{p}^2 } + \frac{ 1.75 \left 1 - \epsilon \right \rho_{g} \left u_{g} + u_{s} \right^{2} }{ \epsilon^{3} d_{p} }
