...
.. index::
   pair: idaes.unit_models.power_generation.boiler_heat_exchanger; BoilerHeatExchanger

.. currentmodule:: idaes.unit_models.power_generation.boiler_heat_exchanger
...
The BoilerHeatExchanger model can be imported from :code:`idaes.unit_models.power_generation`,
while additional rules and utility functions can be imported from
``idaes.unit_models.power_generation.boiler_heat_exchanger``. 
...
.. code:: python
    ...
    from idaes.unit_models.power_generation.boiler_heat_exchanger import BoilerHeatExchanger, TubeArrangement, \
        DeltaTMethod
