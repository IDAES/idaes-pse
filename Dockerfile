...
ADD . /home/idaes
USER root
RUN wget https://idaes-files.s3.amazonaws.com/public/idaes-coinbinary-1.2.0.dev0.zip -P /usr/local
...
WORKDIR /usr/local
RUN unzip idaes-coinbinary-1.2.0.dev0.zip -d /usr/local/coinor-optimization-suite-1.8
