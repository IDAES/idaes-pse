...
# dlist old clcmlist
dlist = ['c1','c2','c3','c4','c5','c6','c7','c8','c9','c10','c11','c12','c13','c14','c15','c16','c17','c18','c19','c20','c21']
rspace = {}
rspace['mechanisms']=list(['iT','ma','rev','homcat','clc','ads']+dlist)
rspace['clc']=list(dlist)
rspace['clcnames']=list(['Random Nucleation','Power law order 2/3','Power law order 2',
                         'Power law order 4','Power law order 3','Power law order 1',
                         'Avrami order 2','Avrami order 3','Avrami order 0.5','Avrami order 1.5',
                         'Avrami order 4','Prout Tompkins','Jander 3d diff','Anti Jander 3d diff',
                         'Valensi','Parabolic','Ginstling-Brountstein 3d diff',
                         'zhuralev lesohkin tempelman','Grain Model'])
rspace['clcforms']=list(['1-X','(n=2/3) nX^(n-1/n)','(n=2) nX^(n-1/n)',
                         '(n=4) nX^(n-1/n)','(n=3) nX^(n-1/n)','(n=1) nX^(n-1/n)',
                         '(n=2) n(1-X)(-ln(1-X))^(n-1/n)','(n=3) n(1-X)(-ln(1-X))^(n-1/n)',
                         '(n=0.5) n(1-X)(-ln(1-X))^(n-1/n)','(n=1.5) n(1-X)(-ln(1-X))^(n-1/n)',
                         '(n=4) n(1-X)(-ln(1-X))^(n-1/n)','X(1-X)',
                         '3(1-X)^(1/3)(1/(1+X)^((-1/3)-1))','3/2(1-X)^(2/3)(1/(1+X)^((-1/3)-1))',
                         '1/(-ln(1-X))','1/(2X)','(3/2)(1-X)^(4/3)((1-X)^((-1/3)-1))^-1',
                         '(3/2)((1-X)^((-1/3)-1))^-1','(1-X)^(2/3)'])
...
sharedata['gasconst'] = .008314 #J/mol K
sharedata['bounds'] = {}
sharedata['bounds']['k'] = {}
sharedata['bounds']['e'] = {}
...
sharedata['kwargsin'] = ['mechanisms','mech','mechs','stoich','stoichiometry','stoichs',
                         'minlp_path','showpyomo','alamo_path','nlp_path',
                         'keepfiles','return_model','Tref','sigma','hide_output','ccon','wls','Tr',
                         'deltaterm','ascale','zscale','onemechper','expand_output',
                         'temp','time','tr','tref','temperature','Temperature','Temp']
# Set paths here
