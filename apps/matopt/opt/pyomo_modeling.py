...
def getLB(e):
    ...
    if (isinstance(e, _GeneralVarData)):
    	...
    	if not isinstance(e.args[1], pyomo.core.base.var._GeneralVarData):
...
def addConGlobalBudget(m, ConName, Vs, Subset=None,
    ...
    Args:
        ...
        Subsets: Optional, indices to sum over. If not provided, the
